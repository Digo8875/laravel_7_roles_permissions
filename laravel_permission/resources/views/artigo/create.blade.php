...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Cadastrar Artigo') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('artigo.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="texto" type="text" class="form-control @error('texto') is-invalid @enderror" name="texto" value="{{ old('texto') }}" required autocomplete="texto">
